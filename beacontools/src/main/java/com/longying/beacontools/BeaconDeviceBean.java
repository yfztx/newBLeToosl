...
public class BeaconDeviceBean {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof BeaconDeviceBean) {
            BeaconDeviceBean mBeacon = (BeaconDeviceBean) o;
            if (mBeacon.getName() != null) {
                return mBeacon.getName().equals(this.getName());
            } else if (mBeacon.getUuid() != null) {
                return mBeacon.getUuid().equals(this.getUuid()) && mBeacon.major == this.major
                        && mBeacon.minor == this.minor;
            } else if (mBeacon.mac != null) {
                return mBeacon.mac.equals(this.mac);
            } else {
                return false;
            }
